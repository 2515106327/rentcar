					...
					<div class="ibox-content">
						<form class="form-horizontal m-t" id="signupForm">
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label">款式：</label>
									<div class="col-sm-9">
										<select class="form-control" name=""
											style="height:35px;width:150px;">
											<option>三厢</option>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" for="-NaN">变速箱：</label>
									<div class="col-sm-9">
										<label class="radio-inline" for="-NaN"> <input
											type="radio" checked="" value="option1" id="-NaN"
											name="optionsRadios">自动</label> <label class="radio-inline"
											for="-NaN"> <input type="radio" value="option2"
											id="-NaN" name="optionsRadios">手动</label>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="" class="form-control" placeholder="元/天"
											style="width:100px"> 
									<span class="help-block m-b-none">格式：豫A-45A23</span>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="" class="form-control"
											placeholder="请输入型号" style="height:35px;width:150px;">
										<span class="help-block m-b-none">例如：福克斯</span>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="" class="form-control"
											placeholder="请输入排量" style="height:35px;width:150px;">
										<span class="help-block m-b-none">例如：1.6L</span>

									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">租用价格：</label>
									<div class="col-sm-9">
										<input type="text" name="" class="form-control" placeholder="元/天"
											style="width:100px"> <span
											class="help-block m-b-none"></span>
